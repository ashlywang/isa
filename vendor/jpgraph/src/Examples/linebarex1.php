...
require_once ($configInfo['vendor'].'/jpgraph/jpgraph.php');
require_once ($configInfo['vendor'].'jpgraph/jpgraph_line.php');
require_once ($configInfo['vendor'].'jpgraph/jpgraph_bar.php');
